...
import { lets_get_this_bread, lgtb } from "./lgtb-functions";
...
const artists = ["Andy Warhol", "Frida Kahlo", "Henri Matisse", "Pablo Picasso", "Salvador Dalí", "Vincent van Gogh"];
...
lets_get_this_bread(client, supabase, "mj-photos", "project-nuance/large/", artists);
// lgtb(client, supabase, "b520dee0-ee3d-4632-bd80-1eb02134ab07", ["Andy Warhol"]);